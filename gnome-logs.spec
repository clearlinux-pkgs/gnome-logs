...
Version  : 3.32.1
Release  : 11
URL      : https://download.gnome.org/sources/gnome-logs/3.32/gnome-logs-3.32.1.tar.xz
Source0  : https://download.gnome.org/sources/gnome-logs/3.32/gnome-logs-3.32.1.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1554742625
...
%files data
%defattr(-,root,root,-)
/usr/share/appdata/org.gnome.Logs.appdata.xml
