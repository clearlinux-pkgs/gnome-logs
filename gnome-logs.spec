...
Version  : 3.28.2
Release  : 5
URL      : https://download.gnome.org/sources/gnome-logs/3.28/gnome-logs-3.28.2.tar.xz
Source0  : https://download.gnome.org/sources/gnome-logs/3.28/gnome-logs-3.28.2.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1525704221
