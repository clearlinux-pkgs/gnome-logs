...
Version  : 3.26.3
Release  : 1
URL      : https://download.gnome.org/sources/gnome-logs/3.26/gnome-logs-3.26.3.tar.xz
Source0  : https://download.gnome.org/sources/gnome-logs/3.26/gnome-logs-3.26.3.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1518019393
