...
Source0  : https://download.gnome.org/sources/gnome-logs/3.36/gnome-logs-3.36.0.tar.xz
...
%prep
%setup -q -n gnome-logs-3.36.0
cd %{_builddir}/gnome-logs-3.36.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1590422655
...
cp %{_builddir}/gnome-logs-3.36.0/COPYING %{buildroot}/usr/share/package-licenses/gnome-logs/8624bcdae55baeef00cd11d5dfcfa60f68710a02
...
/usr/share/help/en_GB/gnome-logs/media/gnome-logs.png
...
/usr/share/help/id/gnome-logs/media/gnome-logs.png
...
/usr/share/help/tr/gnome-logs/media/gnome-logs.png
...
/usr/share/help/uk/gnome-logs/media/gnome-logs.png
